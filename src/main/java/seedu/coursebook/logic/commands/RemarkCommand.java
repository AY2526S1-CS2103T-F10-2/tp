...
import seedu.coursebook.commons.util.CollectionUtil;
...
public class RemarkCommand extends Command {
    ...
    public CommandResult execute(Model model, CommandHistory history) throws CommandException {
        ...
        Person editedPerson = new Person(
                ...
                personToEdit.getAddress(), personToEdit.getTags(), personToEdit.getCourses(),
                personToEdit.getBirthday(), personToEdit.isFavourite(), remark);
