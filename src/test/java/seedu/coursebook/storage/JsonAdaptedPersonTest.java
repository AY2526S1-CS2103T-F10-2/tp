...
import static seedu.coursebook.storage.JsonAdaptedPerson.MISSING_FIELD_MESSAGE_FORMAT;
...
public class JsonAdaptedPersonTest {
    ...
    private static final List<JsonAdaptedCourse> VALID_COURSES = Collections.emptyList();
    private static final String VALID_BDAY = BENSON.getBirthday() != null
            ? BENSON.getBirthday().toString()
            : "01-01-2000";
    private static final String INVALID_BDAY = "31-02-2007";
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ADDRESS, VALID_TAGS, VALID_COURSES, VALID_BDAY, false, "");
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        INVALID_ADDRESS, VALID_TAGS, VALID_COURSES, VALID_BDAY, false, "");
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ADDRESS, invalidTags, VALID_COURSES, VALID_BDAY, false, "");
